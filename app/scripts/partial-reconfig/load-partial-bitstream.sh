...
OUTPUT=$(sh -c "${SCRIPT_DIR}/../../xdma-tools/reg_rw /dev/xdma0_user ${DFX_DECOUPLER_DISCONNECT_REG} w 0x7")
...
OUTPUT=$(sh -c "${SCRIPT_DIR}/../../xdma-tools/reg_rw /dev/xdma0_user ${DFX_DECOUPLER_DISCONNECT_REG} w 0x0")
