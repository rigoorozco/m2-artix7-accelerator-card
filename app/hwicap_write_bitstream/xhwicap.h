...
* 10.1   sk   11/10/15 Used void* instead of uint32_t for Baseaddress CR# 867425.
 ...
 */
typedef void (*XHwIcap_StatusHandler) (void *CallBackRef, uint32_t StatusEvent,
                       uint32_t WordCount);
 ...
 */
typedef struct {
    uint16_t DeviceId;		/**< Device ID  of device */
    void *BaseAddress;	/**< Register base address */
...
typedef struct {
    ...
    uint32_t DeviceIdCode;	     /**< IDCODE of targeted device */
    uint32_t DeviceFamily;		 /**< Targeted device family */
    uint32_t BytesPerFrame;	     /**< Number of Bytes per minor Frame */
    uint32_t WordsPerFrame;	     /**< Number of Words per minor Frame */

#if XPAR_HWICAP_0_ICAP_DWIDTH == 8
    uint8_t *SendBufferPtr;
#elif XPAR_HWICAP_0_ICAP_DWIDTH == 16
    uint16_t *SendBufferPtr;
#else
    uint32_t *SendBufferPtr;
#endif
    uint32_t RequestedWords;	     /**< Number of Words to transfer  */
    uint32_t RemainingWords; 	     /**< Number of Words left to transfer  */
...
* 		void XHwIcap_FifoWrite(XHwIcap *InstancePtr, uint32_t Data);
*
*****************************************************************************/
...
*
* @note		C-style Signature:
* 		uint32_t XHwIcap_FifoRead(XHwIcap *InstancePtr);
*
*****************************************************************************/
...
*
* @note		C-style Signature:
*		void XHwIcap_SetSizeReg(XHwIcap *InstancePtr, uint32_t Data);
*
*****************************************************************************/
...
*		register.
*
* @note		uint32_t XHwIcap_GetControlReg(XHwIcap *InstancePtr);
*
*****************************************************************************/
...
*
* @note		uint32_t XHwIcap_GetStatusReg(XHwIcap *InstancePtr);
*
*****************************************************************************/
...
*
* @note		C-Style signature:
*		uint32_t XHwIcap_IntrGetStatus(InstancePtr)
*
******************************************************************************/
...
*
* @note		Signature:
*		void XHwIcap_IntrDisable(XHwIcap *InstancePtr, uint32_t IntrMask)
*
******************************************************************************/
...
*
* @note		Signature:
*		void XHwIcap_IntrEnable(XHwIcap *InstancePtr, uint32_t IntrMask)
*
******************************************************************************/
...
*
* @note		C-Style signature:
*		uint32_t XHwIcap_IntrGetEnabled(InstancePtr)
*
******************************************************************************/
...
*
* @note		Signature:
*		void XHwIcap_DisableIntr(XHwIcap *InstancePtr, uint32_t IntrMask)
*
******************************************************************************/
...
*
* @note		C-Style signature:
*		uint32_t XHwIcap_GetWrFifoVacancy(InstancePtr)
*
******************************************************************************/
...
*
* @note		C-Style signature:
*		uint32_t XHwIcap_GetRdFifoOccupancy(InstancePtr)
*
******************************************************************************/
 ...
 */
int XHwIcap_CfgInitialize(XHwIcap *InstancePtr, XHwIcap_Config *ConfigPtr, void *EffectiveAddr);
int XHwIcap_DeviceWrite(XHwIcap *InstancePtr, uint32_t *FrameBuffer, uint32_t NumWords);
int XHwIcap_DeviceRead(XHwIcap *InstancePtr, uint32_t *FrameBuffer, uint32_t NumWords);
...
uint32_t XHwIcap_GetConfigReg(XHwIcap *InstancePtr, uint32_t ConfigReg, uint32_t *RegData);
