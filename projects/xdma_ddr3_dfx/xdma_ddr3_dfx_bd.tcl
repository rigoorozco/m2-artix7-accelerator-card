...
proc create_hier_cell_dfx_socket { parentCell nameHier } {
  ...
  ] $axi_clock_converter_static_master
  ...
  set_property -dict [list \
    CONFIG.ALL_PARAMS {HAS_AXI_LITE 0 INTF {resetn {ID 1 VLNV xilinx.com:signal:reset_rtl:1.0 MODE slave SIGNALS {RST {PRESENT 1 WIDTH 1}}} clk {ID 0 VLNV xilinx.com:signal:clock_rtl:1.0 MODE slave SIGNALS\
{CLK {PRESENT 1 WIDTH 1}}}} IPI_PROP_COUNT 0} \
    CONFIG.GUI_HAS_AXIS_CONTROL {false} \
    CONFIG.GUI_HAS_AXIS_STATUS {false} \
    CONFIG.GUI_HAS_AXI_LITE {false} \
    CONFIG.GUI_HAS_SIGNAL_CONTROL {true} \
  ...
  # Create instance: axi_register_slice_static_slave, and set properties
  set axi_register_slice_static_slave [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_register_slice:2.1 axi_register_slice_static_slave ]
  set_property -dict [list \
    CONFIG.ADDR_WIDTH {64} \
    CONFIG.ARUSER_WIDTH {4} \
    CONFIG.AWUSER_WIDTH {4} \
    ...
    CONFIG.WUSER_WIDTH {0} \
  ] $axi_register_slice_static_slave


  # Create instance: axi_register_slice_static_master, and set properties
  set axi_register_slice_static_master [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_register_slice:2.1 axi_register_slice_static_master ]
  set_property -dict [list \
    CONFIG.ADDR_WIDTH {32} \
    CONFIG.DATA_WIDTH {32} \
    CONFIG.HAS_BRESP {1} \
    ...
    CONFIG.WUSER_BITS_PER_BYTE {0} \
  ] $axi_register_slice_static_master


  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins S_AXI] [get_bd_intf_pins axi_interconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_clock_converter_static_master_M_AXI [get_bd_intf_pins axi_register_slice_static_master/S_AXI] [get_bd_intf_pins axi_clock_converter_static_master/M_AXI]
  ...
  connect_bd_intf_net -intf_net axi_register_slice_static_master_M_AXI [get_bd_intf_pins rp_S_AXI] [get_bd_intf_pins axi_register_slice_static_master/M_AXI]
  connect_bd_intf_net -intf_net axi_register_slice_static_slave_M_AXI [get_bd_intf_pins axi_register_slice_static_slave/M_AXI] [get_bd_intf_pins axi_clock_converter_static_slave/S_AXI]
  ...
  connect_bd_intf_net -intf_net rp_M_AXI_1 [get_bd_intf_pins rp_M_AXI] [get_bd_intf_pins axi_register_slice_static_slave/S_AXI]
  ...
  [get_bd_pins dfx_decoupler_clk_resetn/s_clk_CLK]
  ...
  connect_bd_net -net dfx_decoupler_clk_resetn_decouple_status  [get_bd_pins dfx_decoupler_clk_resetn/decouple_status] \
  [get_bd_pins xlconcat_status/In4]
  connect_bd_net -net dfx_decoupler_clk_resetn_rp_clk_CLK  [get_bd_pins dfx_decoupler_clk_resetn/rp_clk_CLK] \
  [get_bd_pins rp_clk] \
  [get_bd_pins axi_clock_converter_static_master/m_axi_aclk] \
  [get_bd_pins axi_clock_converter_static_slave/s_axi_aclk] \
  [get_bd_pins axi_register_slice_static_slave/aclk] \
  [get_bd_pins axi_register_slice_static_master/aclk]
  connect_bd_net -net dfx_decoupler_clk_resetn_rp_resetn_RST  [get_bd_pins dfx_decoupler_clk_resetn/rp_resetn_RST] \
  [get_bd_pins rp_resetn] \
  [get_bd_pins axi_clock_converter_static_master/m_axi_aresetn] \
  [get_bd_pins axi_clock_converter_static_slave/s_axi_aresetn] \
  [get_bd_pins axi_register_slice_static_slave/aresetn] \
  [get_bd_pins axi_register_slice_static_master/aresetn]
  connect_bd_net -net resetn_1  [get_bd_pins resetn] \
  [get_bd_pins axi_clock_converter_static_master/s_axi_aresetn] \
  [get_bd_pins axi_clock_converter_static_slave/m_axi_aresetn] \
...
proc create_root_design { parentCell } {
  ...
  set_property APERTURES {{0x0 8K} {0x8000_0000 128M}} [get_bd_intf_pins /dfx_partition/rp_M_AXI]
  set_property APERTURES {{0x4100_0000 16M}} [get_bd_intf_pins /dfx_partition/rp_S_AXI]
  ...
  connect_bd_intf_net -intf_net dfx_socket_rp_S_AXI [get_bd_intf_pins dfx_socket/rp_S_AXI] [get_bd_intf_pins dfx_partition/rp_S_AXI]
  ...
  [get_bd_pins xdma_0_axi_periph/M00_ACLK] \
  ...
  [get_bd_pins xdma_0_axi_periph/M00_ARESETN] \
